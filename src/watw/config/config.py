...
class ConfigurationFileError(ConfigurationError):
    ...
    def __init__(self, file_path: Union[str, Path], message: str):
        ...
        super().__init__(f"Configuration file error at {self.file_path}: {self.message}")
...
class ConfigurationValueError(ConfigurationError):
    ...
    def __init__(self, key: str, message: str):
        self.key = key
        self.message = message
        super().__init__(f"Invalid value for configuration key '{self.key}': {self.message}")
...
class Configuration:
    ...
    JSON files, as well as accessing settings with type safety.
    ...
    def save(self) -> None:
        ...
        configuration file in JSON format. If the file doesn't exist, it will
        be created.
    ...
    def delete(self, key: str) -> None:
        ...
        This method removes a configuration key and its value, then saves the
    ...
    def __getitem__(self, key: str) -> Any:
        ...
        This method allows accessing configuration values using square bracket
        notation, raising a KeyError if the key doesn't exist.
    ...
    def __setitem__(self, key: str, value: Any) -> None:
        ...
        This method allows setting configuration values using square bracket
        notation.
    ...
    def __contains__(self, key: str) -> bool:
        ...
        This method allows checking if a configuration key exists using the
        'in' operator.
