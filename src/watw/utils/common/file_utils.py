...
def create_temp_file(content: str, extension: str = ".txt", directory: Optional[Union[str, Path]] = None) -> Path:
    """
    ...
    temp_file = tempfile.NamedTemporaryFile(suffix=extension, dir=directory_path, delete=False)
