...
from watw.utils.common.test_utils import (
    MockAPITestCase,
    mock_api_response,
    mock_api_error
)
from watw.utils.common.mock_api_responses import mock_responses
from watw.utils.common.mock_api_client import MockTensorArtClient, MockRunwayMLClient
...
class TestMockAPIResponses(MockAPITestCase):
    ...
    def test_mock_runway_task_status_response(self):
        ...
        task_id = "mock-task-67890"
        response = mock_responses.get_runway_task_status_response(task_id, "COMPLETED", True)
...
class TestMockAPIClients(MockAPITestCase):
    ...
    def test_mock_requests_session(self):
        ...
        response = session.get(f"https://mock-tensorart-api.example.com/v1/jobs/{job_id}")
